...
@objc public class SMSegmentView: UIControl {

    open var segmentAppearance: SMSegmentAppearance?

    // Divider colour & width
    @objc open var dividerColour: UIColor = UIColor.lightGray {
        didSet {
            self.setNeedsDisplay()
        }
    }
     @objc  open var dividerWidth: CGFloat = 1.0 {
        didSet {
    ...
    @objc  public var segments: [SMSegment] = []
    @objc var selectedSegment: SMSegment?
    ...
    // MARK: Add Segment
     @objc  open func addSegmentWithTitle(_ title: String?, onSelectionImage: UIImage?, offSelectionImage: UIImage?) {
    ...
    @objc   open func insertSegmentWithTitle(_ title: String?, onSelectionImage: UIImage?, offSelectionImage: UIImage?, index: Int) {
    ...
    // MARK: Remove Segment
      @objc  open func removeSegmentAtIndex(_ index: Int) {
